...
#define JON_MOD_SSSHADOWS //default on
	...
	#define JON_MOD_SSSHADOWS_RAY_MAX_DISTANCE 100.0 //default 240.0 = 24.0m distance. I think 1 is about 10cm, so a hundred meters is 10000
	...
	#define JON_MOD_SSSHADOWS_RAY_MAX_DISTANCE_NEAR 1.0 //default 1.0 10cm
	#define JON_MOD_SSSHADOWS_BIAS_NEAR 0.05 //0.05, 0.5cm
